  ...
  return (
    <main className="container max-w-6xl space-y-4 my-8">
      ...
      <p>
        ...
        such information and Personal Data, during registration or otherwise, You are
      ...
      <ul className="list-disc ml-10 space-y-4">
        ...
        <li>
          <p>
            ...
            proceeding, in which Personal Data held by Us about our Service users is among
